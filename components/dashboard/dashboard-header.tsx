...
import { DashboardMobileNav, DashboardNavId } from "./dashboard-nav";
...
export function DashboardHeader() {
  ...
  const titles: Record<DashboardNavId, { title: string; subtitle: string }> = {
    overview: { title: "Prehľad", subtitle: "Rýchle odkazy na prácu s projektom" },
    notes: { title: "Poznámky", subtitle: "Správa vašich poznámok k projektu" },
    design: { title: "Dizajn", subtitle: "Pracovný priestor pre dizajn" },
    generate: { title: "Generovať nový dizajn", subtitle: "Generovať nové varianty dizajnu" },
  };
