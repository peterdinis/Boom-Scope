...
export function DashboardContent({ viewer }: { viewer: any }) {
	...
	return (
		...
		>
				...
				<div className="relative flex flex-col gap-3">
					...
					>
						...
						<p className="max-w-2xl text-balance text-sm text-muted-foreground md:text-base">
							Toto je váš pracovný priestor pre projekt. Robte si poznámky,
							navrhujte rozhranie a generujte nové varianty dizajnu — všetko z
							jedného miesta.
						</p>
					</motion.div>
				</div>
			...
			<motion.section variants={childVariants} className="flex flex-col gap-4">
