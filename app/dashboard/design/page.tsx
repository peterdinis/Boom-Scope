	...
	loading: () => (
		<div className="flex h-full w-full items-center justify-center bg-[#050505]">
			<div className="flex flex-col items-center gap-4">
				...
				<p className="text-[10px] font-bold text-white/40 tracking-[0.3em] uppercase animate-pulse">
					Syncing Engine
				</p>
			</div>
		</div>
											...
											>
												...
												>
													{el.isLocked ? (
														...
														<Unlock className="size-3 text-white/40" />
													)}
												</button>
											</div>
										</div>
				...
				{rightPanelOpen && (
					...
					>
						...
						<div className="mt-10 pt-8 border-t border-white/5 grid grid-cols-2 gap-4">
							<Button
								variant="outline"
								className="h-14 rounded-[20px] bg-white/5 border-white/5 hover:bg-white/10 transition-all"
							...
							<Button
								variant="outline"
								className="h-14 rounded-[20px] bg-white/5 border-white/5 hover:bg-white/10 transition-all group"
